...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-50 dark:bg-black border-t border-gray-200 dark:border-white/10 py-16 px-4 transition-colors duration-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-right" dir="rtl">
        <div className="col-span-1 md:col-span-2 flex flex-col items-center md:items-start">
          ...
          <div className="flex gap-4 justify-center md:justify-start flex-row-reverse">
            ...
            <a href="#" className="w-10 h-10 rounded-full bg-gray-200 dark:bg-white/5 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors cursor-pointer text-gray-900 dark:text-white" title="LinkedIn">
              <Linkedin className="w-5 h-5" />
            </a>
            <a href="#" className="w-10 h-10 rounded-full bg-gray-200 dark:bg-white/5 flex items-center justify-center hover:bg-pink-600 hover:text-white transition-colors cursor-pointer text-gray-900 dark:text-white" title="Instagram">
              <Instagram className="w-5 h-5" />
            </a>
            <a href="#" className="w-10 h-10 rounded-full bg-gray-200 dark:bg-white/5 flex items-center justify-center hover:bg-green-500 hover:text-white transition-colors cursor-pointer text-gray-900 dark:text-white" title="WhatsApp">
