    ...
    <div className="pb-24 text-right" dir="rtl">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden bg-neutral-900">
        ...
        <div className="relative z-10 text-center px-4">
          <div className="bg-purple-600/30 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-md border border-white/20">
            <TrendingUp className="h-10 w-10 text-white" />
          </div>
          <h1 className="text-5xl md:text-7xl font-black mb-6">התוצאות מדברות</h1>
      ...
      <section className="max-w-6xl mx-auto px-4 mt-16 space-y-16">
        <div className="text-center mb-12">
            <h2 className="text-3xl font-black text-blue-500 mb-4 tracking-tighter uppercase">Optimize SMS + EMAIL Agency</h2>
            <p className="text-xl text-gray-400">נתונים של עסקים ששיפרנו להם את מחזורי המכירה בצורה משמעותית</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {caseStudies.map((study, idx) => (
                <div key={idx} className="bg-neutral-900 border border-white/10 rounded-[3rem] p-8 md:p-12 hover:border-blue-500/50 transition-all group relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-8">
                        ...
                        <div className="text-left">
                            <p className="text-4xl font-black text-white">{study.increase}</p>
                            <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">Growth rate</p>
                        </div>
                    </div>
                    
                    <h3 className="text-2xl md:text-3xl font-black mb-4">{study.title}</h3>
                    <p className="text-gray-400 mb-8 leading-relaxed font-medium">{study.desc}</p>
                    ...
                    <div className="mt-8 pt-8 border-t border-white/5 flex items-center justify-between">
                         ...
                         <div className="text-white/40 font-bold text-sm italic">Verified Result</div>
                    </div>
                </div>
            ))}
        </div>
      ...
      <section className="mt-32 max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 px-4 mb-32">
        {[
            ...
            <div key={i} className="text-center p-8 rounded-3xl bg-white/5 border border-white/5">
